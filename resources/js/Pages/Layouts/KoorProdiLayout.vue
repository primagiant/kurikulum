...
const sidebarItems = ref([
    {
        ...
        'child': [
            ...
            {
                title: "Pengampuan",
                route_name: "pengampuan.index",
                link: route("pengampuan.index"),
    ...
    },
    {
        ...
        "child": [
            {
                title: "CPL - PL",
                route_name: "map.cpl.pl",
                link: route("map.cpl.pl"),
            },
            {
                title: "BK - CPL",
                route_name: "map.bk.cpl",
                link: route("map.bk.cpl"),
            },
            {
                title: "BK - MK",
                route_name: "map.bk.mk",
                link: route("map.bk.mk"),
            },
            {
                title: "CPL - MK",
                route_name: "map.cpl.mk",
