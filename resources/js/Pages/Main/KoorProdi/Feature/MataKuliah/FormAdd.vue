                ...
                <div class="flex flex-col md:flex-row justify-between gap-4 mb-6 ">
                    <div class="md:w-1/2">
                        <label for="default-kode-mk-obe"
                            ...
                            Mata Kuliah</label>
                        <input type="text" id="default-kode-mk-obe" v-model="form.kode_mk_obe" minlength="4" maxlength="4"
                            required
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Example: MK01">
                    ...
                    <div class="md:w-1/2">
                        <label for="default-kode-mk-undiksha"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode
                            MK Undiksha</label>
                        <input type="text" id="default-kode-mk-undiksha" v-model="form.kode_mk_undiksha" minlength="10"
                            required maxlength="10"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Example: KOMS000001">
